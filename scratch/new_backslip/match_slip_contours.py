...
contours = gpd.read_file("alpine_contours.geojson")
end_points = gpd.read_file(r"C:\Users\arh128\PycharmProjects\cfm_leapfrog\scratch\howarth_alpine\endpoints\Alpine George seaward combined_no_dip_change_endpoints.shp")
...
np.save("matched_slip_contours_ndc.npy", out_arr)
