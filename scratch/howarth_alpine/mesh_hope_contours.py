...
alpine_combined = Path(__file__).parent / "depth_contours" / "Alpine Fully Planar_planar_contours.shp"
...
file_name = Path(__file__).parent / "meshed" / "full_planar_alpine.vtk"
triangulate_contours(spline_contours, file_name, mesh_format="vtk", check_mesh=True)
